...
export default function LoginPage() {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      const dest = ROLE_REDIRECTS[data.user.role];
      if (dest) router.push(dest);
      else throw new Error('Unknown role. Please contact the administrator.');
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-white border-r border-gray-200">
        <div className="flex flex-col justify-between p-12 w-full">
          <div>
            ...
            <h2 className="text-3xl font-semibold text-gray-900 mb-4">Fleet Management<br />Made Simple</h2>
      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-8">
        <div className="w-full max-w-md">
          <div className="lg:hidden text-center mb-8">
            <div className="w-16 h-16 relative mx-auto mb-4"><Image src="/bss-primary-logo.png" alt="VMS" fill className="object-contain" priority /></div>
          ...
          <p className="text-center text-xs text-gray-400 mt-6">© {new Date().getFullYear()} BSS Power Private Limited. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
