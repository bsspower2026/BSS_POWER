...
const fuelLogSchema = new mongoose.Schema({
  ...
  filledByRole: { type: String, trim: true },
  bypass:       { type: Boolean, default: false }
});

const issueReportSchema = new mongoose.Schema({
  description:    { type: String },
  issueType:      { type: String, trim: true },   // 'Tyre Problem' | 'Engine Problem' | 'Vehicle Breakdown' | 'Other'
  issuePhoto: {                                    // optional photo of the issue
    url:       String,
    publicId:  String
  },
...
const tripSchema = new mongoose.Schema({
  ...
  startedByRole:      { type: String, trim: true },
